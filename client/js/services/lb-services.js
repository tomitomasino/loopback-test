      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Notes/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Folder.notes.findById() instead.
            "::findById::Folder::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/folders/:id/notes/:fk",
              method: "GET",
            },

            // INTERNAL. Use Folder.notes.destroyById() instead.
            "::destroyById::Folder::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/folders/:id/notes/:fk",
            ...
            // INTERNAL. Use Folder.notes.updateById() instead.
            "::updateById::Folder::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/folders/:id/notes/:fk",
            ...
            // INTERNAL. Use Folder.notes() instead.
            "::get::Folder::notes": {
              isArray: true,
              url: urlBase + "/folders/:id/notes",
              method: "GET",
            },

            // INTERNAL. Use Folder.notes.create() instead.
            "::create::Folder::notes": {
              url: urlBase + "/folders/:id/notes",
              method: "POST",
            },

            // INTERNAL. Use Folder.notes.createMany() instead.
            "::createMany::Folder::notes": {
              isArray: true,
              url: urlBase + "/folders/:id/notes",
              method: "POST",
            },

            // INTERNAL. Use Folder.notes.destroyAll() instead.
            "::delete::Folder::notes": {
              url: urlBase + "/folders/:id/notes",
              method: "DELETE",
            },

            // INTERNAL. Use Folder.notes.count() instead.
            "::count::Folder::notes": {
              url: urlBase + "/folders/:id/notes/count",
              method: "GET",
            },
          }
        );
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.Folder.notes
     * @header lbServices.Folder.notes
     * @object
     * @description
     *
     * The object `Folder.notes` groups methods
     * manipulating `Note` instances related to `Folder`.
     *
     * Call {@link lbServices.Folder#notes Folder.notes()}
     ...
     */
        ...
        R.notes = function() {
          ...
          var action = TargetResource["::get::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#count
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
             * Counts notes of Folder.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Folder id
        ...
        R.notes.count = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::count::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#create
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.create = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::create::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#createMany
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.createMany = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::createMany::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#destroyAll
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.destroyAll = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::delete::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#destroyById
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.destroyById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::destroyById::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#findById
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.findById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::findById::Folder::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Folder.notes#updateById
             * @methodOf lbServices.Folder.notes
             *
             * @description
             *
        ...
        R.notes.updateById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::updateById::Folder::notes"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/testmodels/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Testmodel#prototype$patchAttributes
             * @methodOf lbServices.Testmodel
             *
             * @description
             *
